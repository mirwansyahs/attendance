    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row card-body">
                <div class="col-md-6">
                    <?=form_open_multipart('hc/holiday/addProses')?>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="HolidayDate" name="HolidayDate" value="">
                    </div>
                    <div class="mb-3">
                        <label class="form-label"><?=lang('number_of_holiday')?></label>
                        <input type="number" class="form-control" id="HolidayNumber" name="HolidayNumber" value="">
                    </div>
