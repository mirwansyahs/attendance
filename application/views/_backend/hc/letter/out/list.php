        ...
        <div class="card-body">
            ...
            <div class="card-title">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <a name="" id="" class="btn btn-primary" style="float: right" href="<?=base_url()?>hc/letter/add/out" role="button">
            ...
            <table id="datatable" class="table table-bordered dt-responsive w-100">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a name="" id="" class="btn btn-primary" href="<?=base_url()?>hc/letter/update/out/<?=$key->ID?>" role="button">
                                <i class="fa fa-edit"></i>
                                <?=lang('ubah')?>
                            </a>
                            <a name="" id="" class="btn btn-danger" href="<?=base_url()?>hc/letter/delete/out/<?=$key->ID?>" role="button">
