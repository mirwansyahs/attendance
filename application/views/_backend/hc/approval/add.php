    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row card-body">
                <div class="col-md-6">
                    <?=form_open_multipart('hc/leave/addProses')?>
                    <div class="mb-3">
                        ...
                        <select name="RequestType" id="RequestType" class="form-control" onchange="checkLeave()">
                            <?php foreach ($RequestType->result as $key) { ?>
                                <option value="<?=$key->ID?>"><?=$key->RequestType?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="mb-3" id="cmpLeaveType">
                        ...
                        <select name="LeaveType" id="LeaveType" class="form-control">
                            <?php foreach ($LeaveType->result as $key) { ?>
                                <option value="<?=$key->ID?>"><?=$key->LeaveTypeName?></option>
                            <?php } ?>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="RequestCause" name="RequestCause"></textarea>
                    </div>
