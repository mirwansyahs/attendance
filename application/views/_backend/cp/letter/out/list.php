    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="card-title">
                <div class="row">
                    <div class="col-md-6">
                        <h4><?=lang('letter_out')?></h4>
                    </div>
                    <div class="col-md-6">
                        <a name="" id="" class="btn btn-primary" style="float: right" href="<?=base_url()?><?=$this->uri->segment(1)?>/letter/add/out" role="button">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php }else{ ?>
                            <a name="" id="" class="btn btn-info" href="<?=base_url()?><?=$this->uri->segment(1)?>/letter/addtodisposisi/out/<?=$key->ID?>" role="button">
                                <i class="fa fa-copy"></i>
                                <?=lang('disposisi')?>
                            </a>
                            <?php } ?>

                            <a name="" id="" class="btn btn-primary" href="<?=base_url()?><?=$this->uri->segment(1)?>/letter/update/out/<?=$key->ID?>" role="button">
                                <i class="fa fa-edit"></i>
                                <?=lang('ubah')?>
                            </a>
                            <a name="" id="" class="btn btn-danger" href="<?=base_url()?><?=$this->uri->segment(1)?>/letter/delete/out/<?=$key->ID?>" role="button">
