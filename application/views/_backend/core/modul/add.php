    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row card-body">
                <div class="col-md-12">
                    <?=form_open_multipart('core/Modul/addProses')?>
                    <div class="mb-3">
                        <label class="form-label"><?=lang('modul_name')?></label>
                        <input type="text" class="form-control" id="ModulName" name="ModulName" value="">
                    </div>
                    <div class="mb-3">
                        <label class="form-label"><?=lang('modul_url')?></label>
                        <input type="text" class="form-control" id="ModulUrl" name="ModulUrl" value="">
                    </div>
                    <div class="mb-3">
                        <label class="form-label"><?=lang('modul_icon')?></label>
                        <input type="text" class="form-control" id="ModulIcon" name="ModulIcon" value="">
                    </div>
