    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row card-body">
                <div class="col-md-6">
                    <?=form_open_multipart('core/Employee/updateProses/'.$id)?>
                    <div class="row mb-4">
                        <div class="col-md-4">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" id="EmployeePosition" name="EmployeePosition">
                            ...
                            <option value="<?=$key->PositionName?>" <?=($key->PositionName == $data->EmployeePosition)?'selected':''?>><?=$key->PositionName?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="mb-3">
